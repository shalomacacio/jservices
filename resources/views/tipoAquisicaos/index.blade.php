...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Tipos de Aquisicao Equipamento</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Cadastros</a></li>
              <li class="breadcrumb-item active">Novo Tipo Aquisicao</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="col-md-12">
        ...
        <div class="card card-warning">
          ...
          <form role="form" action="{{ route('tipoAquisicao.store') }}" method="POST">
          <!-- /.card-header -->
          <div class="card-body">
            @csrf
            <div class="row">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    <form action="{{route('tipoAquisicao.destroy', $tipo->id )}}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="btn btn-danger float-right" onclick="return confirm('Deseja excluir ?')"  >DELETE</button>
                    </form>
                    <a type="button" class="btn btn-warning float-right" href="{{route('tipoAquisicao.edit', $tipo->id )}}">Editar</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
