        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Novo Tipo Pagamento</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="col-md-12">
        ...
        <div class="card card-warning">
          ...
          <form role="form" action="{{ route('tipoPagamento.store') }}" method="POST">
          <!-- /.card-header -->
          <div class="card-body">
            @csrf
            <div class="row">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <form action="{{route('tipoPagamento.destroy', $tipo->id)}}" method="POST">
                        <a class="btn btn-info" href="{{route('tipoPagamento.edit', $tipo->id)}}"  onclick="return confirm('Deseja Editar?')"><i class="fas fa-edit"></i></a>
                        @csrf
                        @method('DELETE')
